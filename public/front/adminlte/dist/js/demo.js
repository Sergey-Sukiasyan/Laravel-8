...
(function ($) {
    ...
    $container.append(`
      ...
      <div class="d-flex align-items-center mt-1">
          <input type="color" style="width:100px;height: 31px" value="#343a40" />
          <button class='btn btn-sm mx-1 btn-secondary' id="btn-active" style="flex-basis:100%">Active</button>
      ...
      <div class="d-flex align-items-center mt-1">
          <input type="color" style="width:100px;height: 31px" value="#343a40" />
          <button class='btn btn-sm mx-1 btn-secondary' id="btn-active-text" style="flex-basis:100%">Active Text</button>
  ...
  document.querySelectorAll(".btn-color").forEach(btn=>{
      ...
      btn.onclick=()=>{
          const color = btn.previousElementSibling.value;
          const id = btn.parentElement.getAttribute("name");
          document.querySelectorAll("#"+id+" a:not(.active)").forEach(elem => {
      ...
      btn.nextElementSibling.onclick =()=>{
          ...
          document.querySelectorAll("#"+id_name+" a:not(.active)").forEach(elem=>{
              elem.style.color = "";
          });
      }
  ...
  document.getElementById("btn-active").onclick=()=>{
    color = document.getElementById("btn-active").previousElementSibling.value;
    document.querySelectorAll("#navnav .active").forEach(elem=>{
  ...
  document.getElementById("btn-active-text").onclick=()=>{
    color = document.getElementById("btn-active-text").previousElementSibling.value;
    document.querySelectorAll("#navnav .active").forEach(elem=>{
      elem.style.color = color;
    });
